...
const apis: ApiItem[] = [
  {
    ...
    priority: 'must',
    status: 'connected',
    description: '네이버에서 들어오는 예약을 CRM으로 자동 동기화합니다.',
    purpose: '네이버 예약 → CRM 자동 연동, 예약 취소/변경 실시간 반영',
    steps: [
      '네이버 스마트플레이스 (smartplace.naver.com) 사업자 등록',
      '스마트플레이스 관리자 > 예약 > 예약 설정 메뉴 진입',
      '외부 예약 시스템 연동 신청 (API 파트너 신청)',
      'API Key 및 PlaceID 발급 후 설정 > 연동 설정에 입력',
      '테스트 예약 1건 생성하여 CRM 동기화 확인',
    ],
    docs: 'https://smartplace.naver.com/biz/partner',
    cost: '무료 (스마트플레이스 기본 제공)',
    estimatedTime: '1~3 영업일 (사업자 인증 포함)',
  },
  {
    id: 'kakao-channel',
    name: '카카오 채널 (카카오톡 비즈)',
